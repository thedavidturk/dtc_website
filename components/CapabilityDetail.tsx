                  ...
                  <div className="relative p-8 pb-0">
                    ...
                    <div className="flex items-start gap-6">
                      <motion.div
                        ...
                        className="w-20 h-20 rounded-2xl flex items-center justify-center text-4xl font-bold text-white shadow-lg"
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {capability.services.map((service, i) => (
                          ...
                          >
                            <div className="w-2 h-2 rounded-full" style={{ backgroundColor: capability.color }} />
                      ...
                      >
                        ...
                        <div className="space-y-3">
                          {capability.details.benefits.map((benefit, i) => (
                            ...
                            >
                              <svg className="w-5 h-5 text-[#FF5C34] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
